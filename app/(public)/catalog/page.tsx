...
import { getProducts, getCategories, getDistinctMaterials, type ProductFilter } from "@/lib/queries";
...
export default async function CatalogPage({ searchParams }: CatalogPageProps) {
  ...
  const [{ products, total, totalPages }, categories, materials] = await Promise.all([
    getProducts({
  ...
  return (
    <div className="container-page py-10">
      ...
      <div className="flex gap-8 mt-8">
        <FilterSidebar categories={categories} materials={materials} />
